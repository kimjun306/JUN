...
<style type = "text/css">
	...
	#footer> ul >li:first-child{ 		/* first-child , last-child만 있음 */
...
<script type = "text/javascript" >
  	...
  	$(document).on("click" , ".btn_agree" , function(){
		...
		var li1 = $('input:checkbox[id="li1box"]').is(":checked");
		var li2 = $('input:checkbox[id="li2box"]').is(":checked");
		
		
		if(li1 == false || li2 == false){
			$("#span_disagree").css("display" , "block");
			return false;
...
<%@include file="header.jsp"%>
	...
	<h1 id ="naver_logo"><a href = "http://www.naver.com" ></a></h1>
	...
	<div id = "contract_container">
		<form action = "register.jsp"  id = "join_content" name = "" method = "post" onReset = "clearForm()">
			<div class = "terms">
				<p class = "terms_p">
				...
				<ul id ="terms_ul">
					...
					<li id = "terms_ul_li2">
						...
						<div class = "terms_box">
							<div class = "article">
								...
								는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용<br>
								기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p><br>
							
								<h3 class = "article_title">1. 수집하는 개인정보</h3>
								<p> 이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 네이버<br> 
								서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그<br> 
								등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, 네이버는<br>
								서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p><br>
							</div>
						</div>
					...
					<li id = "terms_ul_li3">
						...
						<div class = "terms_box">
							<div class = "article">
								...
								<p> 위치정보 이용약관에 동의하시면, <strong>위치를 활용한 광고 정보 수신</strong><br> 
								등을 포함하는 네이버 위치기반 서비스를 이용할 수 있습니다.</p><br>
							
								<h3 class = "article_title">제 1조 (목적)</h3>
								<p> 이 약관은 네이버 주식회사 (이하 “회사”)가 제공하는 위치정보사업 또는<br>
								 위치기반서비스사업과 관련하여 회사와 개인위치정보주체와의 권리,<br>
					...
					<li id = "terms_ul_li4">
						<span class = "ul_li_span">
							...
							<span id = "span_disagree">네이버 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요.</span>	
			...
			<div class = "btn_double_area">
				<span><a href = "ShoppingIndex" class = "btn_type btn_default">비동의</a></span>
	...
	<footer>
		...
		<div id="footer">
			...
			<div id ="address">
				...
				<img id="addr_logo" src="img/naver_logo.png" alt="네이버 로고"></a></span>
